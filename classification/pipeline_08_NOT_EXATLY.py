...
def classify_and_assign_news(limit=5, csv_filename="news_classification.csv"):
    ...
    with open(csv_filename, mode='w', newline='', encoding='utf-8') as csv_file:
        ...
        for article in news_articles:
            ...
            prompt = f"Identify the relevant American city or cities for this news article. Do not provide a sentence, just list the cities as separate lines.\nTitle: {title}\nContent: {content}"
            ...
            try:
                ...
                # Extract response (assumes cities are listed one per line, no full sentences)
